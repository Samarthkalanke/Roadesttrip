...
class Reservations(db.Model):
    ...
    reservationId = db.column(db.String)
        ...
        for reservation in reservations:
            try:
                ...
                for num in range(randrange(1, 4)):
                    ...
                    reservation.posts.append(Post(id=reservation.id, car=reservation.car, LicensePlate=reservation.LicensePlate, person = reservation.person, ReservationDate = reservation.ReservationDate))
